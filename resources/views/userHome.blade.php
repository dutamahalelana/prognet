...
<body>
	...
	<div id="wrapper">
		...
		<nav class="navbar navbar-default navbar-fixed-top">
			<div class="brand">
				<a href="index.html"><img src="{{asset('template/assets/img/logoti')}}" alt="Logo" class="img-responsive logo"></a>
			</div>
			<div class="container-fluid">
				...
				<div id="navbar-menu">
					<ul class="nav navbar-nav navbar-right">
						...
						<li class="dropdown">
							<a href="#" class="dropdown-toggle" data-toggle="dropdown"><img src="{{asset('template/assets/img/user.png')}}" class="img-circle" alt="Avatar"> <span>{{Auth::User()->email}}</span> <i class="icon-submenu lnr lnr-chevron-down"></i></a>
